...
var _optionHelper = require("../../support/option-helper");
...
var ScenarioWorld = /*#__PURE__*/function (_World) {
  ...
  function ScenarioWorld(options) {
    ...
    _defineProperty(_assertThisInitialized(_this), "newBrowser", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var automationBrowser, automationBrowsers;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", (0, _optionHelper.stringIsOfOptions)(automationBrowser, automationBrowsers));
    ...
    _defineProperty(_assertThisInitialized(_this), "browserBuilder", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(browser) {
        var builder, chromeBrowserOptions, firefoxBrowserOptions;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                console.log("\uD83D\uDDA5 Executing on ".concat(browser, " browser \uD83D\uDDA5"));
                builder = new _seleniumWebdriver.Builder();
                _context2.t0 = browser;
                _context2.next = _context2.t0 === "chrome" ? 5 : _context2.t0 === "firefox" ? 8 : 12;
                break;
